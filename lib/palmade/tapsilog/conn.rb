  ...
  class Conn
    ...
    def log(service, instance_key, severity, message, tags = {}, ts = nil)
      ...
      begin
        ...
        $stderr.puts "Failed to write to server! Retrying... (#{tries})" unless @max_tries == -1
    ...
    def real_connect(host, port)
      ...
      begin
        ...
        $stderr.puts "Failed to establish connection with server! Retrying... (#{tries})" unless @max_tries == -1
